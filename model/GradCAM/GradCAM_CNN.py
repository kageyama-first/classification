...
def _project_cnn_module_dir() -> Path:
    return (_project_root() / "classification" / "model" / "CNN" / "code").resolve()
...
def main():
    ...
    parser.add_argument("--ckpt", type=str, default="classification/model/CNN/best_model.pth")
    parser.add_argument("--ckpt-simple", type=str, default="classification/model/CNN/best_model.pth")
    parser.add_argument("--ckpt-advanced", type=str, default="classification/model/CNN/best_model .pth")
