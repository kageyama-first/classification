...
def main():
    ...
    parser.add_argument("--model", type=str, default="simple", choices=["simple", "cbam"])
    ...
    model, model_name = load_model(kind=str(args.model), num_classes=len(class_names), ckpt_path=Path(args.ckpt))
